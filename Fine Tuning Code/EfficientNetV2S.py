...
model = tf.keras.models.load_model('EfficientNetV2S_warmedup.keras')
layers = model.layers
for layer in layers:
  if 'post' in layer.name:
    layer.trainable = True

#for layer in layers:
#  if 'post' in layer.name or 'block14' in layer.name:
#    layer.trainable = True

#for layer in layers:
#  if 'post' in layer.name or 'block14' in layer.name or 'block13' in layer.name:
#    layer.trainable = True

#for layer in layers:
#  if 'post' in layer.name or 'block14' in layer.name or 'block13' in layer.name or 'block12' in layer.name:
#    layer.trainable = True
